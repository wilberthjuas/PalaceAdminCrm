...
use app\models\search\AmbientesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AmbientesController implements the CRUD actions for Ambientes model.
 */
class AmbientesController extends Controller
{
    ...
    {
        $searchModel = new AmbientesSearch();
    ...
    {
        if (($model = Ambientes::findOne($id)) !== null) {
            return $model;
        }
